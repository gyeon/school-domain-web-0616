...
# hogwarts.add_student("Harry Potter", "first year")
# hogwarts.add_student("Fred Weasley", "third year")
# hogwarts.add_student("Ron Weasley", "first year")
# hogwarts.add_student("Oliver Wood", "fifth year")
